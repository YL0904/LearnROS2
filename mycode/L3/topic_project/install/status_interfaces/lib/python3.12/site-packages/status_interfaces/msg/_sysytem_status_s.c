...
bool status_interfaces__msg__sysytem_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("status_interfaces.msg._sysytem_status.SysytemStatus", full_classname_dest, 51) == 0);
  }
  status_interfaces__msg__SysytemStatus * ros_message = _ros_message;
  {  // stamp
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * status_interfaces__msg__sysytem_status__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of SysytemStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("status_interfaces.msg._sysytem_status");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SysytemStatus");
  ...
  status_interfaces__msg__SysytemStatus * ros_message = (status_interfaces__msg__SysytemStatus *)raw_ros_message;
  {  // stamp
    PyObject * field = NULL;

...
#ifndef STATUS_INTERFACES__MSG__DETAIL__SYSYTEM_STATUS__TRAITS_HPP_
#define STATUS_INTERFACES__MSG__DETAIL__SYSYTEM_STATUS__TRAITS_HPP_
...
inline std::string to_yaml(const SysytemStatus & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const status_interfaces::msg::SysytemStatus & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const status_interfaces::msg::SysytemStatus & msg)
{
  return status_interfaces::msg::to_yaml(msg);
}

template<>
inline const char * data_type<status_interfaces::msg::SysytemStatus>()
{
  return "status_interfaces::msg::SysytemStatus";
}

template<>
inline const char * name<status_interfaces::msg::SysytemStatus>()
{
  return "status_interfaces/msg/SysytemStatus";
}

template<>
struct has_fixed_size<status_interfaces::msg::SysytemStatus>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<status_interfaces::msg::SysytemStatus>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<status_interfaces::msg::SysytemStatus>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // STATUS_INTERFACES__MSG__DETAIL__SYSYTEM_STATUS__TRAITS_HPP_

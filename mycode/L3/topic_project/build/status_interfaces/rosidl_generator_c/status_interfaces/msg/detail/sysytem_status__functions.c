...
status_interfaces__msg__SysytemStatus__init(status_interfaces__msg__SysytemStatus * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    status_interfaces__msg__SysytemStatus__fini(msg);
    return false;
  }
  // host_name
...
status_interfaces__msg__SysytemStatus__create(void)
{
  ...
  status_interfaces__msg__SysytemStatus * msg = (status_interfaces__msg__SysytemStatus *)allocator.allocate(sizeof(status_interfaces__msg__SysytemStatus), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(status_interfaces__msg__SysytemStatus));
  bool success = status_interfaces__msg__SysytemStatus__init(msg);
  if (!success) {
...
status_interfaces__msg__SysytemStatus__Sequence__init(status_interfaces__msg__SysytemStatus__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  status_interfaces__msg__SysytemStatus * data = NULL;

  if (size) {
    data = (status_interfaces__msg__SysytemStatus *)allocator.zero_allocate(size, sizeof(status_interfaces__msg__SysytemStatus), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = status_interfaces__msg__SysytemStatus__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        status_interfaces__msg__SysytemStatus__fini(&data[i - 1]);
      }
...
status_interfaces__msg__SysytemStatus__Sequence__fini(status_interfaces__msg__SysytemStatus__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      status_interfaces__msg__SysytemStatus__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  status_interfaces__msg__SysytemStatus__Sequence * array = (status_interfaces__msg__SysytemStatus__Sequence *)allocator.allocate(sizeof(status_interfaces__msg__SysytemStatus__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = status_interfaces__msg__SysytemStatus__Sequence__init(array, size);
  if (!success) {
...
status_interfaces__msg__SysytemStatus__Sequence__destroy(status_interfaces__msg__SysytemStatus__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    status_interfaces__msg__SysytemStatus__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
status_interfaces__msg__SysytemStatus__Sequence__are_equal(const status_interfaces__msg__SysytemStatus__Sequence * lhs, const status_interfaces__msg__SysytemStatus__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!status_interfaces__msg__SysytemStatus__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  status_interfaces__msg__SysytemStatus__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(status_interfaces__msg__SysytemStatus);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    status_interfaces__msg__SysytemStatus * data =
      (status_interfaces__msg__SysytemStatus *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!status_interfaces__msg__SysytemStatus__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          status_interfaces__msg__SysytemStatus__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!status_interfaces__msg__SysytemStatus__copy(
